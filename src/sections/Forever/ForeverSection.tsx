    ...
    >
      ...
      <div className="max-w-5xl mx-auto px-6 relative z-20 space-y-24">
        ...
        <div className="space-y-8">
          ...
          <div className="relative border-l-2 border-dashed border-rose-gold/25 pl-6 md:pl-8 ml-4 md:ml-12 space-y-8">
            {/* 2026 */}
            <motion.div
            ...
            >
              <div className="absolute left-[-32px] md:left-[-40px] top-1.5 w-4 h-4 rounded-full bg-gold border border-gold shadow-sm flex items-center justify-center">
                <Heart size={8} className="text-love-dark" fill="currentColor" />
              </div>
              <span className="text-sm font-bold text-gold font-mono block">2026</span>
              <h4 className="font-serif text-sm text-soft-pink">More Adventures Together</h4>
              <p className="text-[11px] text-soft-pink/65 max-w-lg font-light leading-relaxed">
                Road trips, shared giggles under rainstorms, and capturing blurry photos. Let's make every ordinary weekend extraordinary, Kashish.
              </p>
            </motion.div>
            ...
            <motion.div
              ...
              className="relative space-y-1.5"
            >
              <div className="absolute left-[-32px] md:left-[-40px] top-1.5 w-4 h-4 rounded-full bg-gold/75 border border-gold flex items-center justify-center">
                <Heart size={8} className="text-love-dark" fill="currentColor" />
              </div>
              <span className="text-sm font-bold text-gold font-mono block">2027</span>
              <h4 className="font-serif text-sm text-soft-pink">🌴 The Dream Vacation</h4>
              <p className="text-[11px] text-soft-pink/65 max-w-lg font-light leading-relaxed">
                Exploring European pathways, sharing local delicacies in Japan, and writing postcards back home from the edge of the world.
              </p>
            </motion.div>
            ...
            >
              ...
              <span className="text-sm font-bold text-gold font-mono block">2028</span>
              <h4 className="font-serif text-sm text-soft-pink">🏡 Building Our Home</h4>
              <p className="text-[11px] text-soft-pink/65 max-w-lg font-light leading-relaxed">
                Choosing curtains, planting window flowerboxes, naming our house plants, and building you a massive wooden bookshelf, Kashish.
              </p>
            </motion.div>
            ...
            <motion.div
              ...
              className="relative space-y-1.5"
            >
              <div className="absolute left-[-32px] md:left-[-40px] top-1.5 w-4 h-4 rounded-full bg-gold border border-gold flex items-center justify-center">
                <Heart size={8} className="text-love-dark" fill="currentColor" />
              </div>
              <span className="text-sm font-bold text-gold font-mono block">Forever</span>
              <h4 className="font-serif text-sm text-soft-pink">👵👴 Growing Old Together</h4>
              <p className="text-[11px] text-soft-pink/65 max-w-lg font-light leading-relaxed">
                Holding wrinkled hands on matching balcony rocking chairs, sipping hot cocoa, and knowing that we spent every single tomorrow loving each other.
              </p>
            </motion.div>
          </div>
        </div>
